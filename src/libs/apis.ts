...
import { CreateBookingDto, Room } from "@/src/models/room";
...
export const createBooking = async ({
    ...
    const { data } = await axios.post(
        `https://${process.env.NEXT_PUBLIC_SANITY_PROJECT_ID}.api.sanity.io/v2024-01-11/data/mutate/${process.env.NEXT_PUBLIC_SANITY_DATASET}`,
        mutation,
