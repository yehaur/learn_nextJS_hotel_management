...
const RatingModal: FC<Props> = props => {
    ...
    return (
        <div className={`fixed z-[61] inset-0 flex items-center justify-center ${isOpen
        ...
        >
            <div className="bg-white w-96 p-4 rounded-lg shadow-lg">
                    ...
                    <div className="flex items-center">
                        {starValues.map(value => (
                            <button
                                ...
                                className={`w-6 h-6 ${ratingValue === value ? "text-yellow-500" : "text-gray-200"}`}
                            >
                                <BsStarFill />
                            </button>
                        ))}
                ...
                <div className="flex justify-end">
                    ...
                    >
                        {isSubmittingReview ? "Submitted" : "Submit"}
                    </button>
                    <button
