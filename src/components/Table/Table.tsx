            ...
            <table className="w-full text-sm text-left text-gray-500">
                <thead className="text-xs text-gray-700 uppercase bg-gray-50">
                    <tr>
                        ...
                        <th className="px-6 py-3">Number Days Booked</th>
                ...
                <tbody>
                    {bookingDetails.map(booking => (
                        <tr
                            key={booking._id}
                            className="bg-white border-b hover:bg-gray-70"
                        >
                            <th
                                onClick={() => {
                                    window.location.href = `/rooms/${booking.hotelRoom.slug.current}`
                                }
                                }
                            ...
                            <td className="px-6 py-4">{booking.noOfDays}</td>
