...
const hotelRoom = {
    ...
    fields: [
        ...
        defineField({
            ...
            title: 'Price',
            type: 'number',
            validation: Rule => Rule.required().min(100).error("Minimum 100 dollars!"),
        }),
        defineField({
            name: 'discount',
            title: 'Discount',
        ...
        defineField({
            ...
            type: 'text',
            validation: Rule => Rule.required(),
            initialValue: 'check-in time is 12pm; check-out before 11:59am, \
                           please contact receptionist if  you have any question',
        }),
        defineField({
            name: 'dimension',
            title: 'Dimension',
